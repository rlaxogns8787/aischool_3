...
export default function AgreementScreen({ navigation }: AgreementScreenProps) {
  ...
  const handleToggle = (key: keyof typeof agreements) => {
    ...
    setAgreements(prev => {
      ...
      const allChecked = ['age', 'service', 'privacy', 'marketing', 'location'].every(k => 
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.progressContainer}>
          ...
          <View style={styles.progressStep}>
            ...
            <Text style={[styles.stepText, { color: '#8E8E93' }]}>사용자 정보</Text>
          </View>
          <View style={styles.progressLine} />
          <View style={styles.progressStep}>
            <View style={[styles.stepCircle, { backgroundColor: '#F5F5F5' }]}>
            ...
            <Text style={[styles.stepText, { color: '#8E8E93' }]}>취향 분석</Text>
          </View>
        </View>
        ...
        >
          <View style={styles.checkboxContainer}>
            <View style={[styles.checkbox, agreements.service && styles.checkboxActive]}>
              {agreements.service && <Check size={16} color="#fff" />}
            </View>
            <View style={styles.agreementTextContainer}>
              <TouchableOpacity onPress={() => handleTermsClick('service', '서비스 이용약관')}>
                <Text style={[styles.agreementText, styles.linkText]}>서비스 이용약관</Text>
              </TouchableOpacity>
        ...
        >
          <View style={styles.checkboxContainer}>
            ...
            <View style={styles.agreementTextContainer}>
              <TouchableOpacity onPress={() => handleTermsClick('privacy', '개인정보 처리방침')}>
                <Text style={[styles.agreementText, styles.linkText]}>개인정보 수집 및 이용 동의</Text>
              </TouchableOpacity>
              <Text style={styles.requiredText}>(필수)</Text>
            </View>
          </View>
        ...
        >
          <View style={styles.checkboxContainer}>
            <View style={[styles.checkbox, agreements.location && styles.checkboxActive]}>
              {agreements.location && <Check size={16} color="#fff" />}
            </View>
            <View style={styles.agreementTextContainer}>
              <TouchableOpacity onPress={() => handleTermsClick('location', '위치서비스 이용약관')}>
                <Text style={[styles.agreementText, styles.linkText]}>위치서비스 이용 동의</Text>
              </TouchableOpacity>
        ...
        >
          <View style={styles.checkboxContainer}>
            <View style={[styles.checkbox, agreements.marketing && styles.checkboxActive]}>
              {agreements.marketing && <Check size={16} color="#fff" />}
            </View>
            <View style={styles.agreementTextContainer}>
              <TouchableOpacity onPress={() => handleTermsClick('marketing', '이벤트 및 혜택 안내')}>
                <Text style={[styles.agreementText, styles.linkText]}>이벤트 및 혜택 안내</Text>
              </TouchableOpacity>
              <Text style={styles.requiredText}>(선택)</Text>
            </View>
          </View>
      ...
      <TouchableOpacity
        style={[
          styles.nextButton,
          (!agreements.age || !agreements.service || !agreements.privacy) && styles.nextButtonDisabled
        ]}
        onPress={handleNext}
      >
