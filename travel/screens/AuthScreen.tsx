...
export default function AuthScreen({ navigation, route }: AuthScreenProps) {
  ...
  const handleSignUp = async () => {
    try {
      ...
      // Navigate to preference screen instead of main
  ...
  const handleStepPress = (step: number) => {
    // 현재는 2단계(사용자 정보)이므로 1단계(약관 동의)로만 이동 가능
    if (step === 1) {
      navigation.replace('Agreement', {
        email,
        isSignUp: true,
        direction: 'back'  // 이전 단계로 이동함을 표시
      })
    }
  }
        ...
        <ScrollView style={styles.scrollView}>
          <View style={styles.header}>
            ...
            <Text style={styles.title}>
              {isSocialSignUp ? '추가 정보 입력' : (isSignUp ? '회원가입' : '발길 닿는 곳마다,\n그곳의 이야기가 당신을 기다립니다')}
            </Text>
          </View>
                  ...
                  <View style={styles.inputContainer}>
                    ...
                    >
                      <Text style={[styles.pickerButtonText, !gender && styles.placeholderText]}>
                        {gender ? (gender === 'male' ? '남자' : '여자') : '선택해주세요'}
                      </Text>
                    </TouchableOpacity>
                  </View>
                </>
            ...
            <>
              ...
              <View style={styles.socialContainer}>
                ...
                <View style={styles.socialButtons}>
                  ...
                  >
                    <KakaoIcon width={24} height={24} style={styles.socialIcon} />
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={[styles.socialButton, { backgroundColor: '#03C75A' }]}
                    onPress={() => handleSocialAuth('naver')}
                  >
                    <NaverIcon width={24} height={24} style={styles.socialIcon} />
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={[styles.socialButton, { backgroundColor: '#1877F2' }]}
                    onPress={() => handleSocialAuth('facebook')}
                  >
                    <FacebookIcon width={24} height={24} style={styles.socialIcon} />
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={[styles.socialButton, { backgroundColor: '#000' }]}
                    onPress={() => handleSocialAuth('apple')}
                  >
                    <AppleIcon width={24} height={24} style={styles.socialIcon} />
                  </TouchableOpacity>
                </View>
              </View>
            </>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.inputContainer}>
          ...
          <View style={styles.passwordContainer}>
            ...
            >
              {showPassword ? <EyeOffIcon width={24} height={24} stroke="#8E8E93" /> : <EyeIcon width={24} height={24} stroke="#8E8E93" />}
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.inputContainer}>
          ...
          <View style={styles.passwordContainer}>
            ...
            >
              {showConfirmPassword ? <EyeOffIcon width={24} height={24} stroke="#8E8E93" /> : <EyeIcon width={24} height={24} stroke="#8E8E93" />}
            </TouchableOpacity>
          </View>
        </View>
          ...
          <View style={styles.modalContainer}>
            <View style={styles.pickerHeader}>
              ...
              <TouchableOpacity
                ...
                style={styles.pickerHeaderButton}
              >
                <Text style={[styles.pickerHeaderButtonText, { color: '#007AFF' }]}>완료</Text>
              </TouchableOpacity>
            </View>
            <Picker
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.pickerHeader}>
              ...
              <TouchableOpacity
                onPress={() => {
                  if (selectedBirthYear) handleBirthYearSelect(selectedBirthYear)
                }}
                style={styles.pickerHeaderButton}
              >
                <Text style={[styles.pickerHeaderButtonText, { color: '#007AFF' }]}>완료</Text>
        ...
        >
          <Text style={styles.nextButtonText}>정보 저장</Text>
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
  )
